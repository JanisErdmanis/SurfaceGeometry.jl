...
@show ccall((
             :hello, "/home/janiserdmanis/Documents/eltopo-master-old/mycode/eltopo.so"),Void,
            (Cint,Cdouble,Cint),
            3,3.,1)
...
const libpath = "/home/janiserdmanis/Documents/eltopo-master-old/mycode/"* "eltopo.so"
...
p, t = EllipsoidMeshLoad(1,1,1,0.2)
